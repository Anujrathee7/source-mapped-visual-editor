...
export function buildPrompt(args: BuildPromptArgs): string {
  ...
  return [
    ...
    '',
    'Rules:',
    `  1. Edit line ${loc.line} only. No other line of this file, and no other file,`,
    '     may change.',
    '  2. Do not reformat, re-indent, re-wrap, or re-order anything — not the rest of',
    `     the file, and not line ${loc.line} beyond the change described above.`,
    "  3. Preserve the file's existing indentation, quote style, and line endings.",
    `  4. If line ${loc.line} is not what is described above, write nothing at all and`,
    '     reply exactly `BLOCKED: <reason>`.',
